...
import { Sword, Scroll, Trophy, Zap } from "lucide-react";
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="text-center max-w-4xl mx-auto">
          <div className="mb-8 animate-fade-in">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-pixel text-gold mb-6 text-glow leading-relaxed">
              CodeDungeon
            </h1>
            <p className="text-base md:text-xl text-foreground mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <Button
              ...
              className="bg-gold hover:bg-gold-glow text-background font-pixel text-sm md:text-base px-8 py-6 glow-gold hover:scale-105 transition-all"
            >
              Enter the Dungeon
            </Button>
            <Button
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-12 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="bg-card p-4 md:p-6 pixel-border hover:pixel-border-gold transition-all hover:glow-gold"
              >
                <feature.icon className="w-8 h-8 md:w-12 md:h-12 text-emerald mx-auto mb-4" />
